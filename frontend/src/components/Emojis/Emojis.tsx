...
import { MoodCounter } from '../Teacher/Teacher';
...
const Emojis: React.FC<EmojisProps> = ({handleClick, isStudent, emojisCounts}) => {
    return (
                  ...
                  <div key={emoji.name}>
                    {isStudent ? (
                        <button
                            ...
                            type="button"
                            onClick={() => handleClick && handleClick(emoji.name, emoji.category)}
                        >
                            <img
                        ...
                        <div key={emoji.name} className="teacher_emoji_headband">
                            <img
                                ...
                                alt={emoji.name}
                            />
                            <p role="emojiCount">{emojisCounts && emojisCounts[emoji.name]}</p>
                        </div>
                    )}
                </ div>
              ))}
